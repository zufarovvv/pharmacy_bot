...
const LANG = {
  ru: {
    ...
    adviceSectionTitle: 'РЕКОXBНДАЦИИ',
    ...
    advicePlanReason: 'Проект <b>{project}</b> выполнен на <b>{pct}%</b>. Закажите <b>{n} upak.</b> <b>{prod}</b> до конца квартала — закроете план и заберёте полный бонус.',
    ...
    prodLabelProfit: 'Прибыль с dona',
...
const FAKE_PRODUCTS = {
  'КРКА': [
    { id: 'krka-enal',  name: 'Enalapril',        dosage: '10 mg',  form: 'tab. №20',  price: 12500, retail: 18000, monthly_orders_avg: 20, bonus_pct: 7 },
    { id: 'krka-noli',  name: 'Noliprel Bi-forte', dosage: '5+1.25 mg', form: 'tab. №30', price: 95000, retail: 145000, monthly_orders_avg: 12, bonus_pct: 7 },
    { id: 'krka-zofe',  name: 'Zofenopril',       dosage: '30 mg',  form: 'tab. №28',  price: 78000, retail: 115000, monthly_orders_avg: 8,  bonus_pct: 7 },
    { id: 'krka-loza',  name: 'Lozartan',         dosage: '50 mg',  form: 'tab. №30',  price: 38000, retail: 56000, monthly_orders_avg: 15, bonus_pct: 7 },
    { id: 'krka-sept',  name: 'Septolete',        dosage: '1.2 mg', form: 'pastil №18', price: 22000, retail: 33000, monthly_orders_avg: 35, bonus_pct: 7 },
  ],
  'KUSUM': [
    { id: 'kus-levo',   name: 'Levomekol',       dosage: '40 g',     form: 'malham',       price: 8200,  retail: 12000, monthly_orders_avg: 30, bonus_pct: 3 },
    { id: 'kus-deks',   name: 'Dekspantenol',     dosage: '5%',       form: 'krem 30g',   price: 14500, retail: 22000, monthly_orders_avg: 22, bonus_pct: 3 },
    { id: 'kus-amox',   name: 'Amoksitsillin',     dosage: '500 mg',   form: 'kaps. №20',  price: 18000, retail: 27000, monthly_orders_avg: 18, bonus_pct: 3 },
    { id: 'kus-vita',   name: 'D3 vitamini',       dosage: '2000 XB',  form: 'tomchi 10ml', price: 32000, retail: 48000, monthly_orders_avg: 25, bonus_pct: 3 },
  ],
  'WELFARM': [
    { id: 'wel-para',   name: 'Paratsetamol',      dosage: '500 mg',   form: 'tab. №20',   price: 4500,  retail: 7500,  monthly_orders_avg: 50, bonus_pct: 7 },
    { id: 'wel-ibup',   name: 'Ibuprofen',        dosage: '400 mg',   form: 'tab. №20',   price: 7800,  retail: 12500, monthly_orders_avg: 40, bonus_pct: 7 },
    { id: 'wel-mult',   name: 'Multivitamin',    dosage: 'kompleks', form: 'tab. №60',   price: 48000, retail: 72000, monthly_orders_avg: 18, bonus_pct: 7 },
    { id: 'wel-omeg',   name: 'Omega-3',          dosage: '1000 mg',  form: 'kaps. №60',  price: 65000, retail: 98000, monthly_orders_avg: 14, bonus_pct: 7 },
  ],
  'GETZ PHARMA': [
    { id: 'getz-azit',  name: 'Azitromitsin',      dosage: '500 mg',   form: 'tab. №3',    price: 28000, retail: 42000, monthly_orders_avg: 24, bonus_pct: 7 },
    { id: 'getz-clar',  name: 'Klaritromitsin',    dosage: '500 mg',   form: 'tab. №14',   price: 56000, retail: 85000, monthly_orders_avg: 12, bonus_pct: 7 },
    { id: 'getz-mela',  name: 'Melatonin',        dosage: '3 mg',     form: 'tab. №30',   price: 42000, retail: 65000, monthly_orders_avg: 20, bonus_pct: 7 },
  ],
  'BAYER': [
    { id: 'bay-asp',    name: 'Aspirin Kardio',   dosage: '100 mg',   form: 'tab. №30',   price: 35000, retail: 52000, monthly_orders_avg: 28, bonus_pct: 7 },
    { id: 'bay-can',    name: 'Kanesten',         dosage: '1%',       form: 'krem 20g',   price: 48000, retail: 72000, monthly_orders_avg: 16, bonus_pct: 7 },
    { id: 'bay-cipro',  name: 'Tsiprofloksatsin',   dosage: '500 mg',   form: 'tab. №10',   price: 22000, retail: 33000, monthly_orders_avg: 22, bonus_pct: 7 },
  ],
  'FERON': [
    { id: 'fer-ifn',    name: 'Interferon',       dosage: '500000 XB', form: 'shamcha №10',  price: 95000, retail: 142000, monthly_orders_avg: 15, bonus_pct: 7 },
    { id: 'fer-anaf',   name: 'Anaferon',         dosage: 'bolalar uchun',   form: 'tab. №20',   price: 28000, retail: 42000, monthly_orders_avg: 32, bonus_pct: 7 },
  ],
  'SAFE': [
    { id: 'safe-glov',  name: 'Nitril qoʻlqop', dosage: 'M oʻlcham', form: 'dona 100', price: 75000, retail: 112000, monthly_orders_avg: 18, bonus_pct: 7 },
    { id: 'safe-mask',  name: 'Tibbiy niqob',    dosage: '3 qatlam',   form: 'dona 50',  price: 22000, retail: 33000,  monthly_orders_avg: 25, bonus_pct: 7 },
  ],
};

const DEFAULT_FAKE_PRODUCTS = [
  { id: 'gen-1', name: 'Preparat A', dosage: '—', form: 'upak.', price: 25000, retail: 38000, monthly_orders_avg: 20, bonus_pct: 7 },
  { id: 'gen-2', name: 'Preparat B', dosage: '—', form: 'upak.', price: 18000, retail: 27000, monthly_orders_avg: 28, bonus_pct: 7 },
  { id: 'gen-3', name: 'Preparat C', dosage: '—', form: 'upak.', price: 42000, retail: 63000, monthly_orders_avg: 14, bonus_pct: 7 },
];
...
const COMPETITOR_MAP = {
  'Septolete':         { competitor: 'Strepsils',         brand: 'Reckitt',         reason: 'Xuddi shu taʼsir doirasi, bonusi pastroq.' },
  'Enalapril':         { competitor: 'Enam',              brand: "Dr. Reddy's",     reason: 'Analogi, lekin yetkazib berish beqarorroq.' },
  'Noliprel Bi-forte': { competitor: 'Loristu',           brand: 'Berlin-Chemie',   reason: 'Dorixona uchun qimmat, marjasi past.' },
  'Lozartan':          { competitor: 'Kozaar',            brand: 'MSD',             reason: 'Import, marjasi kamroq.' },
  'Zofenopril':        { competitor: 'Zokardis',          brand: 'Berlin-Chemie',   reason: 'Yaqin analog, chakana uchun qimmatroq.' },
  'Paratsetamol':       { competitor: 'Kalpol',            brand: 'GSK',             reason: 'Import — narxi baland, marjasi past.' },
  'Ibuprofen':         { competitor: 'Nurofen',           brand: 'Reckitt',         reason: 'Brend qimmatroq, lekin bizda marja yuqori.' },
  'Levomekol':        { competitor: 'Baktroban',         brand: 'GSK',             reason: 'Taʼsir doirasi torroq, qimmatroq.' },
  'Dekspantenol':      { competitor: 'Bepanten',          brand: 'Bayer',           reason: 'Tarkibi bir xil, bizda marjangiz yuqori.' },
  'D3 vitamini':        { competitor: 'Akvadetrim',        brand: 'Polpharma',       reason: 'Bonusi kamroq analog.' },
  'Omega-3':           { competitor: 'Doppelgerts Omega', brand: 'Queisser',        reason: 'Qimmatroq, marjasi past.' },
  'Kanesten':          { competitor: 'Klotrimazol gen.',  brand: 'generiklar',       reason: 'Marjasi minimal generik.' },
  'Aspirin Kardio':    { competitor: 'Kardiomagnil',      brand: 'Takeda',          reason: 'Analog, DATFO bonusi yuqori.' },
  'Azitromitsin':       { competitor: 'Sumamed',           brand: 'Pliva',           reason: 'Brend qimmatroq, marjasi kamroq.' },
  'Melatonin':         { competitor: 'Melarena',          brand: 'RZS',             reason: 'Javonda qimmatroq.' },
};
